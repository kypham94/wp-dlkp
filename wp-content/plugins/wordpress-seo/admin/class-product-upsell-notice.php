...
class WPSEO_Product_Upsell_Notice {
	...
	protected function get_premium_upsell_section() {
		...
		if ( $features->is_free() ) {
			return sprintf(
				...
				"<a href='" . WPSEO_Shortlinker::get( 'https://dulichkhampha.net/yoa/premium-notification' ) . "'>",
				'</a>'
			);
		}
	...
	protected function get_notification() {
		$message = sprintf(
			...
			'Yoast SEO',
			'<a href="' . WPSEO_Shortlinker::get( 'https://dulichkhampha.net/yoa/rate-yoast-seo' ) . '">',
			'</a>'
		) . "\n\n";
		...
		$message .= sprintf(
			...
			'<a href="' . WPSEO_Shortlinker::get( 'https://dulichkhampha.net/yoa/bugreport' ) . '">',
			'</a>'
		) . "\n\n";
