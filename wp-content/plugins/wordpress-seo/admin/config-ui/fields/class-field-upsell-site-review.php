...
class WPSEO_Config_Field_Upsell_Site_Review extends WPSEO_Config_Field {
	...
	public function __construct() {
		...
		$upsell_text = sprintf(
			...
			'<a href="' . WPSEO_Shortlinker::get( 'https://dulichkhampha.net/yoa/yoastseotraining' ) . '" target="_blank">Yoast SEO for WordPress training</a>',
			'<a href="' . WPSEO_Shortlinker::get( 'https://dulichkhampha.net/yoa/configuration-wizard-copywrite-course-link' ) . '" target="_blank">',
			'</a>'
		);
