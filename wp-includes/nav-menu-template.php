...
function wp_nav_menu( $args = array() ) {
	...
	$search = '<li menu-item menu-item-type-post_type menu-item-object-page menu-item-search><form action="https://dulichkhampha.net" id="searchform" method="get"><div class="col-md-8 col-sm-8"><input class="form-control" type="text" id="s" name="s" value="Search" /></div><div class="col-md-4 col-sm-4"><button type="submit" class="btn btn-primary mb-2">Tìm kiếm</button></div></form></li>';
